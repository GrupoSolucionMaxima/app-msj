...
const mapArticleForHome = (a: ArticleFromApi): HomeContentItem => {
    ...
    const categoryColor = a.category.toLowerCase().includes("tour operadores") ? 'bg-[#EE3048]' : 'bg-primary';
        ...
        const fetchTourOperador = async () => {
            ...
            try {
                ...
                const filteredData = mappedArticles
                    .filter(item =>
                        item.category.toLowerCase().includes("tour operadores")
                    )
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: '#f4f4f5' }}>
            ...
            <View style={styles.containerText}>
                ...
                <Text style={styles.subtitle}>Tour de operadores</Text>
            </View>
